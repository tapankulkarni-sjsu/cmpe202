...
public class BuildOrder {
    ...
    public static Component getOrder()
    {
        ...
        String[] bo = { "Harmon & Antibiotic Free Beef", "1/3lb.", "On A Bun" } ;
        b.setOptions( bo ) ;
        // 1 cheese free, extra cheese +1.00
        Cheese c = new Cheese( "Cheese Options" ) ;
        String[] co = { "Horseradish Cheddar" } ;
        c.setOptions( co ) ;
        c.wrapDecorator( b ) ;
        ...
        Premium p = new Premium( "Premium Topping Options" ) ;
        String[] po = { "Marianated Tomatoes" } ;
        p.setOptions( po ) ;
        p.wrapDecorator( t ) ;
        ...
        String[] pc = { "Danish Blue Cheese" } ;
        premiumCheese.setOptions(pc);
        premiumCheese.wrapDecorator(s);
